...
штатитвы</a></div>
                ...
                <div class="col-lg-9 col-md-12 bread">
                    ...
                    <div class="zag">
                        ...
                        <div class="row shade">
                            <div class="col-4"><img src="img/cir1.png" alt="img"></div>
                            <div class="col-8">
                                <div class="frezi">Фрезы</div>
                                <div class="primren">Применение:</div>
                                <div class="trehst">
                                    Трехсторонняя фреза используется для обработки изделий из легких металлов. Повышенная скорость фрезерования, обработка труднодоступных уступов, а также высокая прочность обусловили...
                                </div>
