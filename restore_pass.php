        ...
        <form id='bel_fon'>
            <div class="row justify-content-center">
               <div class="col-12 col-md-6  left_bord">
                   <div class="midd htot">Восстановление пароля</div>
                   <div class="form-group">
                       <label class="htot" for="exampleInputEmail1">Email или телефон*</label>
                       <input type="email" class="inpi" id="exampleInputEmail1" ariadescribedby="emailHelp"
                       placeholder="">
                   </div>
                   <button type="submit" class="btn btn-danger red_butt mx-auto d-flex">Выслать новый пароль</button>
               </div>
           </div>
       </form>
