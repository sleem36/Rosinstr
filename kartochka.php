            ...
            <div class="col-lg-9 col-md-12 bread">
                ...
                <div class="row d-none d-lg-flex">
                    ...
                    <div class="col-12">
                        ...
                        <div class="pokaz-par pokaz-par-begin filtr_1200">
                            <div class="doppar-n">
                                <a class="doppar">Сортировка по параметрам</a>
                            </div>
                        ...
                        <div class="pokaz-par pokaz-par-end filtr_1200_otkr">
                            <div class="doppar-n">
...
<div class="text">
            ...
            <div id="accordion" class="accordion vi_dostav s992">
                <div class="card mb-0">
                    <div class="card-header collapsed" data-toggle="collapse" href="#collapse1">
                        <div class="sr1 stab" onclick="">Описание</div>
                    </div>
                    ...
                    <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse3">
                        <div class="sr1 stab">Обозначения</div>
                    </div>
                    <div id="collapse3" class="collapse" data-parent="#accordion">
                        ...
                        <div class="pokaz-par pokaz-par-begin filtr_320">
                            <div class="doppar-n">
                                <a class="doppar ink">Фильтр</a>
                            </div>
                        </div>


                        <div class="pokaz-par pokaz-par-end filtr_320_otkr">
                            <div class="doppar-n">
                                <a class="doppar">Фильтр</a>
                            </div><br><br>
                            <div class="row w-100">
                                <div class="col-5 novinka">Новинка</div>
                                <div class="col-5 raspord">Распродажа</div>
                            </div><br>
                                <div class="row w-100 charka-bott wrap">
                                    <button type="button" class="btn btn-light filtr-butt filtr-butt-light">Отмена</button>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <button type="submit" class="btn btn-danger red_butt filtr-butt">Применить</button>
                                </div>
                            <div class="row w-100">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <span class="htot">Цена</span>
                                    <div class="catalog__filter-range fs">
                                        <div class="catalog__filter-range-price">
                                            <span class="catalog__filter-range-input-t">от</span>
                                            <input name="filter_Price[]" class="catalog__filter-range-input hist" type="text" id="amount1">
                                            <span class="catalog__filter-range-input-t">до</span>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 xert">
                                    <span class="htot" for="radio">Обозначение по ГОСТу</span>
                                    <label for="male" class="lab-for samovivoz">
                                        <input placeholder='Введите' name="filter_Price[]" class="catalog__filter-range-input hist w-100" type="text" id="amount1">
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <span class="htot" for="radio">Материал</span>
                                    <select class="custom-select catalog__filter-range-input w-100">
                                        <option selected="">Выберите</option>
                                        <option value="1">Boots</option>
                                        <option value="2">Shoes</option>
                                        <option value="3">Feet</option>
                   ...
                   <div id="form_top2" class="stuk fi">
                        <form method="get" class="form-inline my-lg-0">
                            <input class="form-control" type="search" placeholder="Поиск по каталогу" aria-label="Поиск" value="">
                            <img id="fikus_top2" class="dugru2" src="img/lupa.png" alt="img">
                        </form>
                    ...
                    <div class="row korz-min ">
                        <div class="col-10">
                            ...
                            <div class="row">
                                <div class="qty qty-min col-12 col-sm-7">
                                    <div class="number">
                        ...
                        <div class="col-2 raspord-h h100"></div>
                ...
                <div class="row pagin-bott">
                    <div class="col-12 col-lg-4 pagin-bott-filtr">
                        Показывать товаров:
                        <select class="custom-select catalog__filter-range-input">
                    ...
                    <div class="col-12 charka-bott">
                        <a href='' class='float-right bottom-clkik'><img src="img/big_korz.png" alt="img"></a>
                        <button type="submit" class="btn btn-danger red_butt">Купить в 1 клик</button>
                    </div>
                </div>
